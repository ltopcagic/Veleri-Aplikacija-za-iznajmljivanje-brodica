...
Route::delete('/pregledbrodica/brisanje/{brodica}/', [App\Http\Controllers\BrodicaController::class, 'destroy']);
...
Route::delete('/pregledservisa/brisanje/{servis}', [App\Http\Controllers\SevisiController::class, 'destroy']);
...
Route::delete('/pregledciscenja/brisanje/{ciscenje}', [App\Http\Controllers\CiscenjaController::class, 'destroy']);
...
Route::delete('/preglediznajmljenihbrodica/brisanje/{iznajmljenabrodica}', [App\Http\Controllers\IznajmljenaBrodicaController::class, 'destroy']);
