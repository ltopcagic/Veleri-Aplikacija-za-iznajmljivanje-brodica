...
@include('layouts.errors')
    ...
    <form method="POST" action="/pregledbrodica/{{ $brodica->id }}/">
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" value="0" id="broj_ljudi" name="broj_ljudi" required value="{{ $brodica->broj_ljudi }}">
        </div>

        <div class="form-group">
            <label for="cijena">Cijena iznajmljivanja brodice:</label>
            <input type="number" class="form-control" value="0" id="cijena" name="cijena" required value="{{ $brodica->cijena }}">
        </div>
